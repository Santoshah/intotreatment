...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_menu_page(__('Theme Options', 'options_framework_theme'), __('Theme Options', 'options_framework_theme'), 'edit_theme_options', 'options-framework','optionsframework_page', content_url('/themes/awesome/images/minimalthemes-icon-16.png'), 61);		
...
function optionsframework_load_scripts($hook) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear', 'optionsframework' ),
			'defaultString' => __( 'Default', 'optionsframework' ),
			'pick' => __( 'Select Color', 'optionsframework' )
		);
...
function optionsframework_page() {
    ...
    <div id="icon-themes" class="icon32 aw_icon"><img src="<?php echo get_template_directory_uri(); ?>/admin/images/minimal-theme-icon.png" /></div>
