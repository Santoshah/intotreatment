...
<?php if ( 1 == $first && is_home() && !is_paged() ) { ?>
								...
								<div class="featured post">
									...
									<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
										...
										<a class="ajax-load-link" href="<?php the_permalink(); ?>" id="<?php the_ID(); ?>"><img src="<?php echo $post_thumb_img[0]; ?>" alt="<?php the_title(); ?>" width="<?php echo $post_thumb_img[1]; ?>" height="<?php echo $post_thumb_img[2]; ?>" /></a>
										<?php } ?>										
										
										<h3><a class="ajax-load-link" href="<?php the_permalink(); ?>" id="<?php the_ID(); ?>"><?php the_title(); ?></a></h3>
...
<?php } else { ?>  								
								...
								<div class="mini post">
									...
									<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
										...
										<a class="ajax-load-link" href="<?php the_permalink(); ?>" id="<?php the_ID(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/blogPostImage1.jpg" alt="<?php the_title(); ?>" /></a>
										
										<?php } ?>	

										<h4><a class="ajax-load-link" href="<?php the_permalink(); ?>" id="<?php the_ID(); ?>"><?php the_title(); ?></a></h4>
