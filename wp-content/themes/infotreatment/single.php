										...
										<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
											...
											?>									
												...
												<div class="meta-post">
													...
													<?php 
													printf(__('<p>By: <span class="author-screen"><a class="url fn n" href="%1$s" title="%2$s" rel="author">%3$s</a></span></p><p><span class="category">Category: %4$s</span></p>', 'awesome'),
											...
											<div class="tags">
												<?php printf( __( '<span class="%1$s">Tags: </span> %2$s', 'text-domain' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list );
												$show_sep = true; ?>
											</div>
